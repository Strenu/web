...
class TestimonialsSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> testimonials = [
      {
        'quote':
            'Strenu transformed our internal processes. Their cloud solution is robust, scalable, and has saved us countless hours.',
        'author': 'Jane Doe',
      ...
      {
        'quote':
            'The mobile app they developed exceeded our expectations. The team\'s technical expertise and commitment are second to none.',
        'author': 'John Smith',
      ...
      {
        'quote':
            'Working with them felt like a true partnership. They are agile, transparent, and delivered on time and on budget.',
        'author': 'Emily White',
